...
This guide provides detailed information on understanding and leveraging MailGreet's analytics and reporting features to measure the success of your email marketing campaigns.
...
1. Check the MailGreet Knowledge Base for analytics articles
2. Contact support with specific questions
3. Consider scheduling a session with MailGreet's customer success team
